...
import { EndpointParameterInstructionsSupplier, getEndpointFromInstructions, toEndpointV1 } from '@aws-sdk/middleware-endpoint'
...
export class Upload extends EventEmitter {
  ...
  private async __uploadUsingPut(dataPart: RawDataPart): Promise<void> {
    ...
    if (eventEmitter !== null && eventEmitter.off) {
