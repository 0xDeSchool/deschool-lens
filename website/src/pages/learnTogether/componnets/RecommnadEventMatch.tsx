          ...
          {info?.courses?.map((course) => {
            return (<SwiperSlide key={`${course.id}`} className="mx-auto rounded-16px frc-center">
              <div className="frc-between gap-4">
                <div className="relative h-160px aspect-[433/280] object-cover rounded-2 bg-white shadow">
                  <Image
                    preview={false}
                    src={course?.coverImage}
                    alt="coverImage"
                    className="relative h-160px aspect-[433/280] object-cover rounded-2"
                    ...
                    placeholder={
                      <Image
                        ...
                        height={160}
                        width={280}
                        className="h-160px aspect-[433/280] object-cover rounded-2"
                      />
                    }
                  />
                </div>
