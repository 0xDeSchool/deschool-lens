...
const RecommnadEventMatch: React.FC<RecommnadEventMatchProps> = (props) => {
  ...
  return (
    <div className="h-full self-start">
      ...
      <div className="divider w-full h-1px bg-gray-200 my-4" />
      <h1 className="text-xl font-500 font-Anton mb-4">Get prepared on deschool before the event</h1>
      <div className="frc-between gap-4">
        <img className="max-w-120px h-120px rounded-2" src="https://deschool.s3.amazonaws.com/seriesCovers/6323d96759c18e0e54fd677a33a1ad4e-a682-48a7-8bfb-56b9e01c16b7.jpg" alt="course cover"/>
