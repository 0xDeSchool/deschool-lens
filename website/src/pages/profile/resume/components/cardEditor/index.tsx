    ...
    <Modal title={isCreateCard ? 'Create new experience' : 'Edit experience'} open={isEditCard} onOk={onSubmit} onCancel={handleCancel}>
      ...
      >
        <Form.Item
          ...
          hidden={isCreateCard}
          rules={[{ required: false, message: 'Please input your experience title' }]}>
        ...
        <Form.Item name="isPresent" valuePropName="checked">
          <Checkbox>Currently working here
            <p className='text-gray'>*By checking this box, this experience will appear on your social card.</p>
          </Checkbox>
        </Form.Item>
